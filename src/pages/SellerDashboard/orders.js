                        ...
                        <table className="table">
                          <tbody className="transaction">
                            <tr className="table-head">
                             ...
                             <tr>
                              <td><p>items.id</p></td>
                              <td><p>items.seller_name</p></td>
                              <td><p>items.seller_registration_date</p></td>
                              <td><p>items.seller_agreement_number</p></td>
                              <td><p>items.status</p></td>
                              <td><p>items.seller_address</p></td>
                              <td><p>items.created_at</p></td>
                              <td><p>items.updated_at</p></td>
                            </tr> 
                          </tbody>
                        </table>
                      </div>
